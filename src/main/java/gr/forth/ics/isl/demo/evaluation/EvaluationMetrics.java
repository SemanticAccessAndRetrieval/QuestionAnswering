...
public class EvaluationMetrics {
    ...
    public static double R_Precision(ArrayList<Integer> groundTruth, int R) {
    ...
    public static double BPREF(ArrayList<Integer> groundTruth, int R) {
        double Sum = 0.0;
        int nonRels = 0;
    ...
    public static void main(String[] args) throws IOException, FileNotFoundException, ClassNotFoundException {
        ...
        System.out.println(R_Precision(groundTruth, 10));
        System.out.println(AVEP(groundTruth, 10));
    }
}
